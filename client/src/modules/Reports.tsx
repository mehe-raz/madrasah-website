        ...
        {reports.map((r) => (
          <div key={r.title} style={{ background: C.card, borderRadius: 12, border: `1px solid ${C.border}`, padding: 20 }}>
            ...
            <div style={{ display: "flex", gap: 8 }}>
              <button type="button" disabled={loading !== null} onClick={() => handleExport(r.kind, "print")} style={{ flex: 1, background: r.color + "18", color: r.color, border: `1px solid ${r.color}40`, borderRadius: 7, padding: "7px 10px", cursor: "pointer", fontSize: 12, fontWeight: 600 }}>
