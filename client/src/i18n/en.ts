...
export const en = {
  ...
  settings: {
    title: "Settings",
    madrasaInfo: "Institution Information",
    ...
    prayerCity: "Prayer-time city",
    prayerCountry: "Country",
    prayerHint: "The dashboard prayer-times widget shows timings for this city (calculation method: University of Islamic Sciences, Karachi)",
    useCurrentLocation: "Use current location",
    locatingGps: "Locating...",
    gpsLocationSet: "GPS location",
    gpsLocationActive: "Precise GPS location active (used instead of the city above)",
    clearGpsLocation: "Clear",
    gpsUnsupported: "Location isn't supported in this browser",
    gpsDenied: "Couldn't get your location — allow location access in the browser",
    manualLocationHint: "If GPS/internet isn't available, copy coordinates from Google Maps and enter them here directly",
    manualLat: "Latitude",
    manualLng: "Longitude",
    invalidLatLng: "Enter a valid coordinate (Latitude: -90 to 90, Longitude: -180 to 180)",
    ...
    restoreHelp: "Upload a downloaded backup to restore old students, income, users and settings.",
    ...
    // docs/SHIFT_SCHEDULE_PLAN.md, Phase 6 — shift management section.
    shiftManagement: "Shift Management",
    shiftManagementHint: "Create shifts, then assign each class/jamaat to one below. If entry time is later than the shift's start time + grace minutes, status is automatically set to 'দেরিতে' (late).",
    shiftAddTitle: "Add New Shift",
    shiftEditTitle: "Edit Shift",
    shiftNameLabel: "Shift Name",
    shiftNameEnLabel: "Name (English, optional)",
    shiftStartLabel: "Start Time",
    shiftEndLabel: "End Time",
    shiftGraceLabel: "Grace Minutes",
    shiftSave: "Save",
    shiftSaving: "Saving...",
    shiftCancel: "Cancel",
    shiftEdit: "Edit",
    shiftActivate: "Activate",
    shiftDeactivate: "Deactivate",
    shiftEmptyList: "No shifts added yet",
    shiftFieldsRequired: "Name, start and end time are required",
    shiftSaveFailed: "Failed to save",
    classShiftMapTitle: "Class ↔ Shift Assignment",
    classShiftMapHint: "Choose a shift for each class/jamaat — everyone in the same class shares the same shift.",
    classShiftMapNone: "No shift",
    classShiftMapSave: "Save Assignments",
    classShiftMapSaved: "Class-shift assignments saved",
    classShiftMapSaveFailed: "Failed to save assignments",
  },
  attendance: {
    title: "Attendance",
    date: "Date",
  ...
  staff: {
    title: "Staff",
    subtitle: "Add and manage teachers and other staff",
    loadFailed: "Failed to load",
    addNew: "Add New Staff",
    editTitle: "Edit Staff",
    nameLabel: "Name",
    namePlaceholder: "Staff's full name",
    phoneLabel: "Phone Number",
    designationLabel: "Designation",
    designationOther: "Other",
    designationOtherPlaceholder: "Enter designation",
    classLabel: "Class (teachers only)",
    joiningDateLabel: "Joining Date",
    fingerprintId: "Fingerprint ID",
    cardUid: "Card UID",
    optional: "Optional",
    noteLabel: "Note",
    linkedUserLabel: "Link software login (optional)",
    linkedUserNone: "No login linked",
    linkedUserHint: "To create/edit a login account, go to the \"Users\" section in Settings.",
  ...
  results: {
    ...
    subjectCustomOption: "+ Other subject (type your own)",
    subjectCustomBack: "Choose from list",
  ...
  pricing: {
    title: "Plans & Pricing",
    subtitle: "Pick the plan that fits your institution",
  ...
  websiteMgmt: {
    ...
    departmentsSummary: "Your institution's departments and programs.",
