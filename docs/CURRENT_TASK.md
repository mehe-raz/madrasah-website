...
- [ ] **Phase 3B ব্যবহারকারীর মেশিনে বিল্ড+টেস্ট (এই সাব-ফেজের মূল বাকি
  কাজ)** — `cd hardware-bridge && npm install && npm run build`, তারপর
  `dist/madrasah-bridge.exe` + পাশে একটা `.env` রেখে exe চালিয়ে দেখা
  আগের মতোই "✓ কনফিগারেশন ঠিক আছে" আসছে কিনা, আর `raw-requests.log`
  exe-এর পাশে ঠিকভাবে তৈরি হচ্ছে কিনা। সমস্যা হলে (চালু না হওয়া,
  অবিলম্বে বন্ধ হওয়া, antivirus false-positive ইত্যাদি) রেজাল্ট
  জানালে এই এন্ট্রি থেকেই ঠিক করা হবে।
- [ ] Phase 4 (4A → 4B) — প্ল্যান ডকের ধারা ৪-এ ঠিক যে ক্রমে লেখা আছে
  সেই ক্রমেই। Phase 3B-এর বিল্ড/টেস্ট রেজাল্টের অপেক্ষা না করেই Phase 4
  শুরু করা যায় (গাইড পেজ কোড/UI-নির্ভর, exe-বিল্ড-নির্ভর না) — exe
  কাজ না করলেও গাইডে দুটো অপশনই (Node.js দিয়ে চালানো / exe দিয়ে
  চালানো) লেখা থাকবে, ব্যবহারকারী যেটা কাজ করে সেটাই ব্যবহার করবেন।
