...
- [ ] **Phase 3A ব্যবহারকারীর মেশিনে যাচাই** (ঐচ্ছিক, ব্লকিং না) —
  `cd hardware-bridge && npm install && npm start` চালিয়ে টার্মিনালে
  "✓ কনফিগারেশন ঠিক আছে" (সঠিক `.env` দিলে) অথবা ইচ্ছাকৃতভাবে ভুল মান
  দিয়ে "⚠ সতর্কতা"/নির্দিষ্ট এরর মেসেজ আসছে কিনা দেখা।
- [ ] **Phase 3B (আসল স্ট্যান্ডঅ্যালোন `.exe`)** — শুরুর আগে ব্যবহারকারীর
  কনফার্মেশন লাগবে (নতুন dev-dependency যেমন `pkg` + ব্যবহারকারীর নিজের
  Windows মেশিনে বিল্ড/টেস্ট করা লাগবে, sandbox-এ আসল exe চালিয়ে
  device/network আচরণ যাচাই সম্ভব না)। ব্যবহারকারী না চাইলে bridge
  Node.js দিয়েই (`npm start`) চালানো যথেষ্ট, exe বানানো ছাড়াই।
- [ ] Phase 4 (4A → 4B) — প্ল্যান ডকের ধারা ৪-এ ঠিক যে ক্রমে লেখা আছে
  সেই ক্রমেই, Phase 3 (অন্তত 3A) শেষ হওয়ার পরই শুরু (গাইড আগের Phase-এর
  আসল UI/ফ্লো রেফারেন্স করে)।
