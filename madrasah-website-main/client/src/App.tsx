...
function PageFallback() {
  // Intentionally not a spinner: in-app navigation should feel like the page is
  // already there and quietly finishing up, not "loading" from scratch.
  return (
...
export default function App() {
  useEffect(() => {
    // Signals the reload-only splash screen (index.html) that the app shell has
    // mounted, so it can fade out. Has no effect on normal in-app navigation.
